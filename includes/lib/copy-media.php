...
/**
 * Check for Duplicates (existing images imported from Flight)
 */
$args = array(
...
if($posts && get_option('fbc_duplicates') === "true") {
	...
	if($_POST['featured_image'] != null) {
		//$set_featured = set_post_thumbnail($_POST['post_id'],$id);
		add_post_meta($_POST['post_id'],'_thumbnail_id',$id);
	}
	$attachment_id = ($_POST['featured_image'] != null) ? $id : -1;
